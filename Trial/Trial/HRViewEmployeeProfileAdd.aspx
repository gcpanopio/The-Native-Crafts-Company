<%@ Page Title="" Language="C#" MasterPageFile="~/HRView.master" AutoEventWireup="true" CodeBehind="HRViewEmployeeProfileAdd.aspx.cs" Inherits="Trial.HRViewEmployeeProfileAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="RightContent" runat="server"> 
    ...
    <div class="HREditProfile">
        ...
        <p><strong>Address:&nbsp;&nbsp;&nbsp; </strong>
            <asp:TextBox ID="TextBox1" runat="server" Width="454px" CssClass="longTB3"></asp:TextBox></p>
        ...
        <p><strong>Birthdate:</strong></p><p class="DateInput3">
        ...
        <p><strong>Location:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>
          ...
          <p><strong>Date Hired: </strong> </p><p class="DateInput4"> 
    ...
    <p>
            <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                Text="Save Changes" CssClass="HRsaveButton"/>
            <asp:Button ID="Button2" runat="server" onclick="Button2_Click" Text="Cancel" 
                CssClass="HRcancelButton"/></p>
    </div>
</asp:Content>
