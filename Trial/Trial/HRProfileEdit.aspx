<%@ Page Title="" Language="C#" MasterPageFile="~/HR.Master" AutoEventWireup="true" CodeBehind="HRProfileEdit.aspx.cs" Inherits="Trial.HRProfileEdit" %>
        ...
        <div class="profileView">
            <div class = "profileRight">
                ...
                <p> <strong>Address:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>
                    <asp:TextBox ID="TextBox1" class="longTB" runat="server" 
                        style="width:70%; "></asp:TextBox></p>
