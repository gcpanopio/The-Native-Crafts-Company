...
namespace Trial
{
    public partial class HRViewEmployeeProfile : System.Web.UI.Page
    {
        int VemployeeNo;
        SqlConnection con;
        SqlDataAdapter da;
        ...
        private void DisplayProfile()
        {
            ...
            {
                Label14.Text = "Successfully added new profile!";
                Session["profileUpdate"] = 0;
            }
            else if (update == 3)
            {
                Label14.Text = "Successfully added new profile! Email to employee not sent.";
                Session["profileUpdate"] = 0;
            }
        }
        ...
        {
            if (Convert.ToInt32(Session["empNo"]) == VemployeeNo)
            {
                Label14.Text = "You cannot edit your own profile.";
            }
            else
            {
                Response.Redirect("HRViewEmployeeProfileEdit.aspx", false);
            }
        }
