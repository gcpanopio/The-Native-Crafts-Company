...
namespace Trial
{
    public partial class SMViewInventory : System.Web.UI.Page
    {
        SqlConnection con;
        SqlDataAdapter ad;
        SqlDataAdapter ad1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT [Location_No] FROM LOCATION WHERE [Location_Name] = '" + Session["locName"] + "' ";
            ad = new SqlDataAdapter(sql, con);
            ad.Fill(ds, "targetLocNos");               //LAHAT NG LOCATIONS NA PWEDE
            ...
            foreach (GridViewRow gvr in GridView1.Rows)
            {
                ...
                ad1 = new SqlDataAdapter(sql, con);
                ad1.Fill(ds1, "TransQty");
                ...
                foreach (DataRow dRow1 in ds1.Tables["TransQty"].Rows)
                {
                    ...
                    foreach (DataRow dRow2 in ds2.Tables["AgentNoProd"].Rows)
                    {
                        ...
                        {
                            foreach (DataRow dRow4 in ds.Tables["targetLocNos"].Rows)
                            {
                                if (Convert.ToInt32(dRow3.ItemArray.GetValue(0)) == Convert.ToInt32(dRow4.ItemArray.GetValue(0)))
                                {
