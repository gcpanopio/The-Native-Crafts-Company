<%@ Page Title="" Language="C#" MasterPageFile="~/SMReport.master" AutoEventWireup="true" CodeBehind="SMViewInventory.aspx.cs" Inherits="Trial.SMViewInventory" %>
<asp:Content ID="Content2" ContentPlaceHolderID="RightContent" runat="server">
     <br /><br />
     <asp:GridView DataKeyNames="product_no" ID="GridView1" runat="server" 
       AutoGenerateColumns="False" DataSourceID="SqlDataSource2" OnRowDataBound="GridView1_RowDataBound" 
       Height="149px" style="width:100%;"  CellPadding="4" ForeColor="#333333" 
